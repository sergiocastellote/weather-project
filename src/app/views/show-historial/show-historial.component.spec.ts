...
describe('ShowHistorialComponent', () => {
  let component: ShowHistorialComponent;
  let fixture: ComponentFixture<ShowHistorialComponent>;
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(ShowHistorialComponent);
