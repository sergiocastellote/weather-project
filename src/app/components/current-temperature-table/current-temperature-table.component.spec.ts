...
describe('CurrentTemperatureTableComponent', () => {
  let component: CurrentTemperatureTableComponent;
  let fixture: ComponentFixture<CurrentTemperatureTableComponent>;
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(CurrentTemperatureTableComponent);
